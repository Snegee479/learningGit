...
public class MainController {
	...
	res.sendRedirect("productStatus.jsp");
	}
	...
	public String deleteProduct(HttpServletRequest req,HttpServletResponse res,@PathVariable("productId") String productId) throws IOException { 
